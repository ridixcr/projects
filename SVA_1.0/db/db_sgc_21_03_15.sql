...
INSERT INTO `autoevaluacion` VALUES (1,18,4,'2014-09-14 19:00:00','2015-06-08 19:00:00',1,'PROCESO DE AUTOEVALUACION-2015'),(2,18,3,NULL,NULL,1,'zxc');
/*!40000 ALTER TABLE `autoevaluacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `comision_interna`
--

DROP TABLE IF EXISTS `comision_interna`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `comision_interna` (
  `idcomision` bigint(20) NOT NULL AUTO_INCREMENT,
  `cargo` varchar(80) DEFAULT NULL,
  `id_persona` bigint(20) NOT NULL,
  PRIMARY KEY (`idcomision`),
  KEY `foreign_key01` (`id_persona`),
  CONSTRAINT `comision_interna_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`idpersona`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `comision_interna`
--

LOCK TABLES `comision_interna` WRITE;
/*!40000 ALTER TABLE `comision_interna` DISABLE KEYS */;
/*!40000 ALTER TABLE `comision_interna` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cuestionario` VALUES (1,1,'CUESTIONARIO PARA DOCENTES',NULL,NULL,0),(2,1,'',NULL,NULL,0),(3,1,'adas',NULL,NULL,1);
...
INSERT INTO `facultad` VALUES (25,'INGENIERÍA DE MINAS, GEOLOGÍA Y CIVIL',86);
...
INSERT INTO `persona` VALUES (22,'Jorge Luis','Sulca','Gonzalez','44038362','999188003','jlsulcag@gmail.com',18,'M'),(23,'as','as','as','12345678','123456','',18,'F'),(24,'xzc','zxc','zxc','zxc','','',18,NULL);
...
INSERT INTO `pregunta_cuestionario` VALUES (1,1,4,'asd',NULL,1);
...
INSERT INTO `pregunta_encuesta` VALUES (1,1,4,'¿como ...?',NULL,NULL,NULL,NULL,NULL,NULL,1);
...
INSERT INTO `respuesta_encuesta` VALUES (1,1,NULL,'DA',NULL);
...
INSERT INTO `rol` VALUES (4,'Administrativo',1),(5,'Alumno',1),(10,'Comisión interna',1),(11,'Docente',1),(12,'Egresado',1),(13,'Grupo de interés',1);
...
INSERT INTO `unidad_academica` VALUES (18,25,'ESCUELA DE FORMACIÓN PROFESIONAL DE INGENIERÍA DE SISTEMAS');
...
INSERT INTO `universidad` VALUES (86,'UNIVERSIDAD NACIONAL DE SAN CRISTÓBAL DE HUAMANGA');
...
INSERT INTO `usuario` VALUES (19,22,'jlsulcag','kokito',NULL,NULL,1),(20,23,'as','as',NULL,NULL,NULL),(21,24,'sad','asd',NULL,NULL,NULL);
...
INSERT INTO `usuario_rol` VALUES (1,12,19),(2,10,20),(3,4,21);
...
-- Dump completed on 2015-03-21  1:29:46
